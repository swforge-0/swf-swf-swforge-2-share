...
?>
<div class="sect-1 flex flex-col flex-a-sb color-1">
    <?php
    ...
    <div class="develop_site_bitrix flex flex-row flex-a-start margin-top-m110 width_40proc color-1 container-mob">
        ...
        <div class="flex flex-col flex-a-start width_60proc margin-top-50 padding-left-50">
            <div class="width-fit">
                <img class="icon-1 transform_icon_1" src="<?php echo SITE_TEMPLATE_PATH;?>/img/bitrix_dev_5.svg" />
            </div>
            <div class="flex-spec-a-center-ta-left margin-left-30 p-1 width_70proc">
...
<div class="sect-2 color-3 flex flex-col flex-a-sb">
    <div class="container flex flex-col flex-a-sb z-index-20">
        <div class="flex flex-row flex-a-start width_70proc">
            <div id="tehpodder" class="tehpodder title-1 width_100proc ta_left margin-left-30">
